...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/tmp/py37/bin',
 'BINLIBDEST': '/tmp/py37/lib/python3.7',
 'BLDLIBRARY': '-L. -lpython3.7m',
 'BLDSHARED': 'gcc -pthread -shared '
              '-Wl,-rpath=/tmp/py37/lib,--disable-new-dtags',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-rpath=/tmp/py37/lib,--disable-new-dtags',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/tmp/py37' '--enable-shared' '--enable-ipv6' "
                "'LDFLAGS=-Wl,-rpath=/tmp/py37/lib,--disable-new-dtags'",
 'CONFINCLUDEDIR': '/tmp/py37/include',
 'CONFINCLUDEPY': '/tmp/py37/include/python3.7m',
 'COREPYTHONPATH': '',
 ...
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/tmp/py37 /tmp/py37/lib /tmp/py37/lib/python3.7 '
             '/tmp/py37/lib/python3.7/lib-dynload',
 'DESTLIB': '/tmp/py37/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/tmp/py37/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/tmp/py37/include /tmp/py37/include '
                   '/tmp/py37/include/python3.7m /tmp/py37/include/python3.7m',
 'INCLUDEDIR': '/tmp/py37/include',
 'INCLUDEPY': '/tmp/py37/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/tmp/py37/lib/python3.7',
 'LIBDIR': '/tmp/py37/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/tmp/py37/lib/pkgconfig',
 'LIBPL': '/tmp/py37/lib/python3.7/config-3.7m-x86_64-linux-gnu',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/tmp/py37/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/tmp/py37/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-rpath=/tmp/py37/lib,--disable-new-dtags',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-rpath=/tmp/py37/lib,--disable-new-dtags',
 'PY_LDFLAGS_NODIST': '',
 ...
 'datarootdir': '/tmp/py37/share',
 'exec_prefix': '/tmp/py37',
 'prefix': '/tmp/py37',
 'srcdir': '.'}
